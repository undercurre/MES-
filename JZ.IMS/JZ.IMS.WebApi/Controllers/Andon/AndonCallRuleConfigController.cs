...
*│　接口名称： IAndonCallRuleConfigController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class AndonCallRuleConfigController : BaseController
	{
		private readonly IAndonCallRuleConfigRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<AndonCallRuleConfigController> _localizer;
		
		public AndonCallRuleConfigController(IAndonCallRuleConfigRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<AndonCallRuleConfigController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<dynamic>>> LoadData([FromQuery]AndonCallRuleConfigRequestModel model)
        {
            ...
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var lists = await _repository.GetRuleConfigDate(model);
        ...
        [HttpPost]
        [Authorize("Permission")]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] AndonCallRuleConfigModel model)
        {
            ApiBaseReturn<bool> returnVM = new ApiBaseReturn<bool>();
            if (!ErrorInfo.Status)
            {
