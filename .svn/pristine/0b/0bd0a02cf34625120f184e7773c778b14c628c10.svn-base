...
*│　接口名称： IAndonCallGroupRuleReController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class AndonCallGroupRuleReController : BaseController
	{
		private readonly IAndonCallGroupRuleReRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<AndonCallGroupRuleReController> _localizer;
		
		public AndonCallGroupRuleReController(IAndonCallGroupRuleReRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<AndonCallGroupRuleReController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<dynamic>>> LoadData([FromQuery]AndonCallGroupRuleReRequestModel model)
        {
            ...
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var lists = await _repository.GetGroupRuleReData(model);
        ...
        [HttpPost]
        [Authorize("Permission")]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] AndonCallGroupRuleReModel model)
        {
            ApiBaseReturn<bool> returnVM = new ApiBaseReturn<bool>();
            if (!ErrorInfo.Status)
            {
