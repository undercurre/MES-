...
*│　接口名称： ISfcsSiteMachineDetailController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class SfcsSiteMachineDetailController : BaseController
	{
		private readonly ISfcsSiteMachineDetailRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<SfcsSiteMachineDetailController> _localizer;
		
		public SfcsSiteMachineDetailController(ISfcsSiteMachineDetailRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<SfcsSiteMachineDetailController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<SfcsSiteMachineDetailListModel>>> LoadData([FromQuery]SfcsSiteMachineDetailRequestModel model)
        {
            ApiBaseReturn<List<SfcsSiteMachineDetailListModel>> returnVM = new ApiBaseReturn<List<SfcsSiteMachineDetailListModel>>();
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var viewList = new List<SfcsSiteMachineDetailListModel>();
                    list?.ForEach(x =>
                    {
                        var item = _mapper.Map<SfcsSiteMachineDetailListModel>(x);
        ...
        [HttpPost]
        [Authorize("Permission")]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] SfcsSiteMachineDetailModel model)
        {
            ApiBaseReturn<bool> returnVM = new ApiBaseReturn<bool>();
            if (!ErrorInfo.Status)
            {
