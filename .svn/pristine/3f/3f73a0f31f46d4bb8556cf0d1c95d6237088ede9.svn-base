...
*│　接口名称： IMesCommonFunctionsController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class MesCommonFunctionsController : BaseController
	{
		private readonly IMesCommonFunctionsRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<MesCommonFunctionsController> _localizer;
		
		public MesCommonFunctionsController(IMesCommonFunctionsRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<MesCommonFunctionsController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<dynamic>>> LoadData(decimal User_ID)
        {
            ...
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var list =await _repository.GetCommonFunctionsByUserID(User_ID);
        ...
        [HttpPost]
        [Authorize]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] MesCommonFunctionsModel model)
        {
