...
*│　接口名称： IMesMessageReceiverGroupController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class MesMessageReceiverGroupController : BaseController
	{
		private readonly IMesMessageReceiverGroupRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<MesMessageReceiverGroupController> _localizer;
		
		public MesMessageReceiverGroupController(IMesMessageReceiverGroupRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<MesMessageReceiverGroupController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<dynamic>>> LoadData([FromQuery]MesMessageReceiverGroupRequestModel model)
        {
            ...
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var lists = await _repository.GetReceiverGroupData(model);
        ...
        [HttpPost]
        [Authorize("Permission")]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] MesMessageReceiverGroupModel model)
        {
            ApiBaseReturn<bool> returnVM = new ApiBaseReturn<bool>();
            if (!ErrorInfo.Status)
            {
