...
*│　接口名称： ISmtFeederRepairItemsController                                      
*└──────────────────────────────────────────────────────────────┘
*/
...
namespace JZ.IMS.WebApi.Controllers  
{
	...
	[ApiController]
	public class SmtFeederRepairItemsController : BaseController
	{
		private readonly ISmtFeederRepairItemsRepository _repository;
		private readonly IMapper _mapper;
		private readonly IHttpContextAccessor _httpContextAccessor;
		private readonly IStringLocalizer<SmtFeederRepairItemsController> _localizer;
		
		public SmtFeederRepairItemsController(ISmtFeederRepairItemsRepository repository, IMapper mapper, IHttpContextAccessor httpContextAccessor,
			IStringLocalizer<SmtFeederRepairItemsController> localizer)
		{
        ...
        [HttpGet]
        [Authorize]
        public async Task<ApiBaseReturn<List<SmtFeederRepairItemsListModel>>> LoadData([FromQuery]SmtFeederRepairItemsRequestModel model)
        {
            ApiBaseReturn<List<SmtFeederRepairItemsListModel>> returnVM = new ApiBaseReturn<List<SmtFeederRepairItemsListModel>>();
            if (!ErrorInfo.Status)
            {
                try
                {
                    ...
                    var viewList = new List<SmtFeederRepairItemsListModel>();
                    list?.ForEach(x =>
                    {
                        var item = _mapper.Map<SmtFeederRepairItemsListModel>(x);
        ...
        [HttpPost]
        [Authorize("Permission")]
        public async Task<ApiBaseReturn<bool>> SaveData([FromBody] SmtFeederRepairItemsModel model)
        {
            ApiBaseReturn<bool> returnVM = new ApiBaseReturn<bool>();
            if (!ErrorInfo.Status)
            {
